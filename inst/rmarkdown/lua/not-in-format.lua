...
--- # not-in-format - keep document parts and headers out of selected output formats.
--
-- This Lua filter for Pandoc extends the original filter (copyright above) to keep also entire section headers out of selected outputs formats.
--
-- @author Julia Schulte-Cloos <julia.schulte@lmu.de>
